    ...
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md p-8 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md shadow-2xl animate-in fade-in zoom-in-95 duration-500">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/60 text-center text-sm">Sign in to view your itineraries or continue planning your next adventure.</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-white/60">
          ...
          <Link href="/register" className="text-white hover:text-primary transition-colors font-medium underline underline-offset-4">
            Sign up
          </Link>
        </div>
      </div>
